...
public interface IServicioRepository extends JpaRepository<Servicio, Integer> {
    ...
    @Query("update Servicio s set s.nombre=:nombre, s.tipo=:tipo, s.costo=:precio, s.descripcion=:descripcion," +
            " s.descripcion=:personalizacion, s.imagen=:imagen where s.codigo =:codigo")
    void updateServicio(
